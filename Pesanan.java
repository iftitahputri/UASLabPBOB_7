...
/**
 * File: Pesanan.java
 * Ini adalah kelas Pesanan utama yang Anda minta.
 * Kelas ini menggunakan Collection (List) untuk menyimpan DetailPesanan.
 * Kelas ini membutuhkan Meja.java dan DetailPesanan.java.
 */
public class Pesanan {
    ...
    /**
     * Catatan: Sesuai Class Diagram, kelas Pesanan tidak menyimpan
     * data Customer secara langsung. Relasi Customer terjadi
     * saat login dan proses pembuatan pesanan oleh Pelayan.
     */
